...
public class SceneStart : MonoBehaviour
{
    ...
    Vector2 constructionTopLeftDaisy = new Vector2(-7f, 2.5f);
    Vector2 constructionTopLeftHuman = new Vector2(-8f, 2.5f);

    Vector2 constructionTopRightDaisy = new Vector2(7f, 2.5f);
    Vector2 constructionTopRightHuman = new Vector2(8f, 2.5f);
