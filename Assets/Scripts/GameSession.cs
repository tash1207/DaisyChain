...
public class GameSession : MonoBehaviour
{
    ...
    void RemoveAllGameBackgroundMusic()
    {
        foreach (AmbienceSounds ambienceSounds in FindObjectsOfType<AmbienceSounds>())
        {
            ambienceSounds.DestroySounds();
        }
    }
